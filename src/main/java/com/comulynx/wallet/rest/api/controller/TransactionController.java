...
public class TransactionController {
	 ...
	 */
	@PostMapping(value = "/last-100-transactions", consumes = { MediaType.APPLICATION_JSON_UTF8_VALUE }, produces = {
	...
	@PostMapping(value = "/send-money", consumes = { MediaType.APPLICATION_JSON_UTF8_VALUE }, produces = {
			MediaType.APPLICATION_JSON_VALUE })
	 ...
	 * @throws ResourceNotFoundException
	 */
	@PostMapping(value = "/mini-statement", consumes = { MediaType.APPLICATION_JSON_UTF8_VALUE }, produces = {
			MediaType.APPLICATION_JSON_VALUE })
